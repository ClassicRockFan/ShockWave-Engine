...
/*
None of this code is made by the author of CandleLight Engine.  He was having a
difficult time with frustum culling and he just got fed up and took it from online.
Thank you Ron Sullivan and Thomas Hourdel.
 */
...
public class FrustumCulling
{
    ...
    {
        return cubeInFrustum( center.getX(), center.getY(), center.getZ(), size );
    }
