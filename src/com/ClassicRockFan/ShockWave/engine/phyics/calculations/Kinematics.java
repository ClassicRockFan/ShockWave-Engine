package com.ClassicRockFan.ShockWave.engine.phyics.calculations;
...
public class Kinematics {
    ...
    public static Vector3f calcDistance(Vector3f velocityInitial, Vector3f acceleration, float time, PhysicsObject object) {
